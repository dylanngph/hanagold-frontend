                ...
                {data.map((item,key)=>{
                    return(
                        ...
                        <div className="fullwidth vien pl-2">
                            <div className="container">
                                <div className="row">
                                    <div className="col-md-3 col-3 float-left Canhgiua pt-5 pb-3">
                                        <Img src={item.logo} onClick={()=> window.location.replace('/#/demotest')}></Img>
                                        
                                    </div>
                                    <div className="col-md-3 col-3 float-left pt-5">
                                    ...
                                    <div className="col-md-6 col-6 float-left">
                                        <div className="row mt-5">
                                            <div className="col-md-6 col-2 arrow-left">

                                            </div>
                                            <div className="col-md-6 col-8 float-left pr-2 " style={{"background-color":"#fdb533"}}>
                                                <Text fontSize="18px" bold className="float-right mt-3" color="primary">Fixed Price</Text>
                                            </div>
