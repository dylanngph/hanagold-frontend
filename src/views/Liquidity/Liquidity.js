  ...
  return (
    <>
      <Card className="max-w-md mx-auto p-5 border-2 border-primary">
        ...
        {renderBody()}
        {account && !v2IsLoading && (
          <div className="text-white text-center py-4 my-4 flex flex-col">
            <p className="mb-5">Don't see a pool you joined?</p>
            <NavLink className="text-primary border-solid border-2 w-full p-3 rounded" to="/find">
              Find other LP tokens
            </NavLink>
          </div>
        )}
        <Link to="/add">
          <Button className="mx-auto flex items-center w-full text-black">
            <Plus /> Add Liquidity
          </Button>
        </Link>
      </Card>
